...
kmi = km.keymap_items.new('export_scene.fbx', 'E', 'PRESS', shift=True, ctrl=True, alt=True)
...
kmi = km.keymap_items.new('outliner.drivers_add_selected', 'D', 'PRESS', shift=True)
kmi = km.keymap_items.new('outliner.drivers_delete_selected', 'D', 'PRESS', alt=True)
kmi = km.keymap_items.new('outliner.selected_toggle', 'BUTTON4MOUSE', 'PRESS')
kmi = km.keymap_items.new('outliner.scroll_page', 'WHEELUPMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'up', True)
kmi = km.keymap_items.new('outliner.scroll_page', 'WHEELDOWNMOUSE', 'PRESS')
...
kmi = km.keymap_items.new('gpencil.select_more', 'NUMPAD_PLUS', 'PRESS')
...
kmi = km.keymap_items.new('pose.select_all', 'BUTTON4MOUSE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('object.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('object.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi = km.keymap_items.new('object.select_all', 'BUTTON4MOUSE', 'PRESS')
kmi = km.keymap_items.new('object.select_more', 'WHEELUPMOUSE', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('curve.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('curve.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'value_1', 'DISABLED')
kmi_props_setattr(kmi.properties, 'value_2', 'CONNECTED')
kmi = km.keymap_items.new('curve.select_all', 'BUTTON4MOUSE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'image_id', 'tool_settings.weight_paint.brush')
kmi_props_setattr(kmi.properties, 'secondary_tex', False)
kmi = km.keymap_items.new('wm.radial_control', 'W', 'PRESS', ctrl=True)
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('mesh.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('mesh.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'value_1', 'DISABLED')
kmi_props_setattr(kmi.properties, 'value_2', 'CONNECTED')
kmi = km.keymap_items.new('mesh.fill_grid', 'F', 'PRESS', shift=True)
kmi = km.keymap_items.new('wm.context_set_value', 'BUTTON4MOUSE', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('wm.context_set_value', 'BUTTON4MOUSE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.mesh_select_mode')
kmi_props_setattr(kmi.properties, 'value', '(False,True,False)')
kmi = km.keymap_items.new('wm.context_set_value', 'BUTTON4MOUSE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.mesh_select_mode')
kmi_props_setattr(kmi.properties, 'value', '(False,False,True)')
kmi = km.keymap_items.new('wm.context_set_value', 'ONE', 'PRESS', shift=True, ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'value', '(True,False,False)')
kmi = km.keymap_items.new('wm.context_set_value', 'TWO', 'PRESS', shift=True, ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'value', '(False,True,False)')
kmi = km.keymap_items.new('wm.context_set_value', 'THREE', 'PRESS', shift=True, ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'value', '(False,False,True)')
kmi = km.keymap_items.new('mesh.select_all', 'BUTTON4MOUSE', 'PRESS')
...
kmi = km.keymap_items.new('mesh.subdivide', 'S', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('mesh.delete_edgeloop', 'X', 'PRESS', alt=True)
kmi = km.keymap_items.new('mesh.vert_connect_path', 'BUTTON5MOUSE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'direction', 'CHILD')
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('armature.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('armature.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi = km.keymap_items.new('armature.select_all', 'BUTTON4MOUSE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('lattice.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('lattice.select_less', 'NUMPAD_MINUS', 'PRESS')
kmi = km.keymap_items.new('object.vertex_parent_set', 'P', 'PRESS', ctrl=True)
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('particle.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('particle.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'use_accurate', False)
kmi_props_setattr(kmi.properties, 'use_planar_constraint', False)
kmi = km.keymap_items.new('view3d.cursor3d', 'BUTTON5MOUSE', 'PRESS', shift=True, ctrl=True, alt=True)
...
kmi.active = False
kmi = km.keymap_items.new('view3d.dolly', 'MIDDLEMOUSE', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('wm.context_toggle', 'M', 'PRESS', ctrl=True, alt=True)
...
kmi.active = False
kmi = km.keymap_items.new('view3d.view_selected', 'BUTTON4MOUSE', 'PRESS', alt=True)
kmi.active = False
...
kmi_props_setattr(kmi.properties, 'delta', -1)
kmi = km.keymap_items.new('transform.translate', 'G', 'PRESS')
kmi = km.keymap_items.new('transform.translate', 'BUTTON5MOUSE', 'PRESS', shift=True)
kmi = km.keymap_items.new('transform.rotate', 'BUTTON5MOUSE', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('transform.resize', 'BUTTON5MOUSE', 'PRESS', alt=True)
kmi = km.keymap_items.new('view3d.move', 'MIDDLEMOUSE', 'PRESS')
kmi = km.keymap_items.new('view3d.dolly', 'MIDDLEMOUSE', 'PRESS', ctrl=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('uv.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('uv.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi = km.keymap_items.new('uv.select_all', 'BUTTON4MOUSE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('mask.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('mask.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi = km.keymap_items.new('graph.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('graph.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi = km.keymap_items.new('image.view_zoom_in', 'WHEELUPMOUSE', 'PRESS')
kmi = km.keymap_items.new('image.view_zoom_out', 'WHEELDOWNMOUSE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'mode', 'MARKERS_BETWEEN')
kmi = km.keymap_items.new('action.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('action.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'left_right', 'NONE')
kmi_props_setattr(kmi.properties, 'linked_time', True)
kmi = km.keymap_items.new('sequencer.select_more', 'NUMPAD_PLUS', 'PRESS')
kmi = km.keymap_items.new('sequencer.select_less', 'NUMPAD_MINUS', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'mode', 'WEIGHT_PAINT')
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('object.origin_set', 'MIDDLEMOUSE', 'PRESS', ctrl=True, alt=True)
kmi.active = False
...
kmi = km.keymap_items.new('anim.channels_select_all_toggle', 'BUTTON4MOUSE', 'PRESS')

# Map View3D Fly Modal
km = kc.keymaps.new('View3D Fly Modal', space_type='EMPTY', region_type='WINDOW', modal=True)

kmi = km.keymap_items.new_modal('CANCEL', 'MIDDLEMOUSE', 'ANY', any=True)
kmi = km.keymap_items.new_modal('CONFIRM', 'RIGHTMOUSE', 'ANY', any=True)
...
kmi = km.keymap_items.new('anim.driver_button_add', 'D', 'PRESS', shift=True)
kmi = km.keymap_items.new('anim.driver_button_remove', 'D', 'PRESS', alt=True)
